    ...
    <main className="min-h-screen bg-[#111827]">
      ...
      <section className="pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/contact"
            className="px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold text-base md:text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 inline-block"
          >
            Start Chatting →
          </Link>
        </div>
      ...
      <section className="py-12 md:py-20 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 md:mb-10 text-center">
            Featured Products
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {productList.map((product) => (
              ...
              >
                ...
                <span className="text-[10px] md:text-xs text-purple-400 font-medium">{product.category}</span>
                <h4 className="text-sm md:text-xl font-semibold text-white mt-1 mb-1 md:mb-2 line-clamp-1">{product.name}</h4>
                <p className="text-gray-400 text-xs md:text-sm mb-2 md:mb-4 line-clamp-2 hidden md:block">{product.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-4 mt-6">
                <a href="#" className="w-10 h-10 bg-white/5 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors text-sm">FAQ</a></li>
                <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors text-sm">Shipping Info</a></li>
                <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors text-sm">Returns & Exchanges</a></li>
                <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors text-sm">Track Order</a></li>
              </ul>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-2">
                  <div className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-xs text-gray-400">Visa</div>
                  <div className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-xs text-gray-400">MC</div>
                  <div className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-xs text-gray-400">bKash</div>
                </div>
              </div>
            </div>
          </div>
